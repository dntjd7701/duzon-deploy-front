  ...
  return (
    <footer className='px-8 pt-24 pb-8'>
      <div className='container max-w-6xl flex flex-col mx-auto'>
          ...
          <div className='flex col-span-2 items-center gap-10 mb-10 lg:mb-0 md:gap-36'>
            {LINKS.map(({ title, items }) => (
              <ul key={title}>
                ...
                {items.map((link) => (
                  <li key={link}>
                    <Typography placeholder={''} as='a' href='#' className='py-1 font-normal !text-gray-700 transition-colors hover:!text-gray-900'>
                      {link}
                    </Typography>
                  </li>
                ))}
            ...
            <div className='flex mb-3 flex-col lg:flex-row items-start gap-4'>
              <div className='w-full'>
                ...
                <Typography placeholder={''} className='font-medium mt-3 !text-sm !text-gray-500 text-left'>
                  I agree the{' '}
                  <a href='#' className='font-bold underline hover:text-gray-900 transition-colors'>
        ...
        <Typography placeholder={''} color='blue-gray' className='md:text-center mt-16 font-normal !text-gray-700'>
